...
class Backend{{ModelClass}}ControllerTest extends TestCase {
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */
	...
	public function test_get_model_list_in_backend() {
		...
		// act
		$data = $this->postData('/api/backend/{{slug}}', [], $this->getBackendHeaders());
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// */
	...
	public function test_get_model_in_backend() {
		...
		// act
		$data = $this->getData('/api/backend/{{slug}}/'.${{slug}}->id, [], $this->getBackendHeaders());
	...
	public function test_get_model_in_backend_not_found() {
		...
		// act and assert
		$this->getError('/api/backend/{{slug}}/3ec9fc3b-a102-40b6-bd61-743f8bd2403b');
	}
	...
	public function test_get_model_in_backend_unauthenticated() {
		...
		// act
		$response = $this->getJson('/api/backend/{{slug}}/'.${{slug}}->id, $this->getBackendHeaders());
