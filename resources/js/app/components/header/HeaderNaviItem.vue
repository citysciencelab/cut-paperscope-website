...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<template>
		...
		<!-- WITH LINK -->
		<router-link v-bind="$attrs" v-if="to || path" :to="to?link(to,params):{path}" :class="['header-navi-item',{active:isActive}]">
			{{ t(label) }}
		</router-link>

		<!-- EXTERNAL LINK -->
		<a v-else-if="href" v-bind="$attrs" :class="['header-navi-item',{active:isActive}]" :href="href" target="_blank" rel="noopener noreferrer">
			{{ t(label) }}
		</a>

		<!-- NO LINK -->
		<div v-else v-bind="$attrs" :class="['header-navi-item',{active:isActive}]" @click="$emit('click')">
			{{ t(label) }}
		</div>
