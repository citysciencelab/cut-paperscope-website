...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<template>
		...
		<nav v-if="user" :class="['header-navi',{dropdown:isDropdown},{open:isOpenDropdown}]">
			...
			<div id="header-navi-container" class="header-navi-content">
				<component :is="isDropdown ? 'scroller' : 'div'">
					...
					<header-navi-item to="backend.index" label="Dashboard"/>
					<backend-navi v-if="isMobile || isTabletPortrait"/>
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<script setup>
		...
		const { isMobile, isTabletPortrait, mobileBreakpoint } = useBreakpoints();
